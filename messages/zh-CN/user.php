...
return [
    ...
    'Assignments' => '分配',
    'Awesome, almost there. Now you need to click the confirmation link sent to your new email address' => '太棒了，现在你只需要点击发送到您的新电子邮件地址的确认链接',
    'Awesome, almost there. Now you need to click the confirmation link sent to your old email address' => '太棒了，现在你只需要点击发送到您的新电子邮件地址的确认链接',
    'Complete password reset on {0}' => '在 {0} 上重置密码',
    'Confirm account on {0}' => '确认 {0} 上的帐户',
    'Confirm email change on {0}' => '确认邮箱改变 {0}',
    'Confirmation status' => '确认状态',
    'Confirmation time' => '确认时间',
    'Create' => '创建',
    'Credentials will be sent to the user by email' => '证书将被发送到用户的电子邮件',
    'Delete' => '删除',
    'Don\'t have an account? Sign up!' => '还没有帐号，现在注册',
    'In order to finish your registration, we need you to enter your email address' => '为了完成注册，我们需要您填写电子邮件地址',
    'Invalid or expired link' => '无效或过期的链接',
    'New email' => '新邮箱',
    'New permission' => '新权限',
    'New role' => '新角色',
    'New user' => '新用户',
    ...
    'Profile details have been updated' => '个人资料详情已被更新',
    'Recovery link is invalid or expired. Please try requesting a new one.' => '找回链接无效或过期，请重新请求。',
    'Recovery message sent' => '找回消息发送',
    'Registration IP' => '注册IP',
    'Roles' => '角色',
    'Something went wrong' => '出错了',
    'Something went wrong and your account has not been confirmed.' => '出错了，你的帐户没有被确认。',
    'Thank you, registration is now complete.' => '恭喜您，注册成功。',
    'The confirmation link is invalid or expired. Please try requesting a new one.' => '确认链接无效或过期，请重新请求。',
    'Unconfirmed' => '未确认',
    'Update' => '更新',
    'User is not found' => '用户未找到',
    'VKontakte' => '',
    'We have sent confirmation links to both old and new email addresses. You must click both links to complete your request' => '我们已经发出确认链接到旧的和新的电子邮件地址。你必须点击两个链接完成您的请求',
    'Welcome! Registration is complete.' => '欢迎，注册完成。',
    'Yandex' => '',
    'You can assign multiple roles or permissions to user by using the form below' => '您可以使用下面的表格指定多个角色或权限给用户',
    'You can connect multiple accounts to be able to log in using them' => '你可以连接多个帐号来登录使用他们',
    'You can not block your own account' => '你不能锁定自己的帐户',
    'You can not remove your own account' => '你不能删除自己的帐户',
    'You can now log in with the following credentials:' => '您现在可以用以下信息登录：',
    'Your account details have been updated' => '您的帐户信息已更新',
    'Your account has been connected' => '您的帐户已被连接',
    'Your account on {0} has been created' => '你在 {0} 上的帐号已经被创建',
    'Your confirmation token is invalid or expired' => '你确认令牌无效或过期',
    'Your email address has been changed' => '您的电子邮件地址已经改变',
